...
const SettingsSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'pomodoroMinutes': PropertySchema(
      id: 2,
      name: r'pomodoroMinutes',
      type: IsarType.long,
    ),
...
void _settingsSerialize(
  ...
  writer.writeLong(offsets[2], object.pomodoroMinutes);
...
Settings _settingsDeserialize(
  ...
  object.pomodoroMinutes = reader.readLong(offsets[2]);
...
extension SettingsQueryFilter
  ...
  QueryBuilder<Settings, Settings, QAfterFilterCondition>
      pomodoroMinutesEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'pomodoroMinutes',
        value: value,
      ));
    });
  }
...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByPomodoroMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pomodoroMinutes', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByPomodoroMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pomodoroMinutes', Sort.desc);
    });
  }
...
extension SettingsQuerySortThenBy
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByPomodoroMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pomodoroMinutes', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByPomodoroMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'pomodoroMinutes', Sort.desc);
    });
  }
...
extension SettingsQueryWhereDistinct
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByPomodoroMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'pomodoroMinutes');
    });
  }
...
extension SettingsQueryProperty
  ...
  QueryBuilder<Settings, int, QQueryOperations> pomodoroMinutesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'pomodoroMinutes');
    });
  }
