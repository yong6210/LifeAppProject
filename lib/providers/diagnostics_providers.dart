...
final timerDiagnosticsServiceProvider =
    FutureProvider<TimerDiagnosticsService>((ref) async {
  return TimerDiagnosticsService.create();
});

final timerAccuracySamplesProvider =
    FutureProvider<List<TimerAccuracySample>>((ref) async {
