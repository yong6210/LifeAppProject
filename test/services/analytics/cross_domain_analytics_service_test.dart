...
void main() {
  group('CrossDomainAnalyticsBuilder', () {
    test('computes correlations and averages', () {
      ...
      expect(analytics.focusSleepCorrelation, greaterThan(0.8));
      expect(analytics.sleepMoodCorrelation, greaterThan(0.8));
      expect(analytics.focusMoodCorrelation, greaterThan(0.8));
