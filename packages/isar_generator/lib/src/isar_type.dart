...
const TypeChecker _dateTimeChecker = TypeChecker.typeNamed(
  DateTime,
  inSdk: true,
);
bool _isDateTime(Element? element) =>
...
extension DartTypeX on DartType {
  IsarType? get _primitiveIsarType {
    if (isDartCoreBool) {
      ...
      if (_isDateTime(typeElement)) {
        return IsarType.dateTime;
      } else if (typeElement?.embeddedAnnotation != null) {
